...
import {
  ...
  QueryOptionsForTupleOfUint128AndUint64,
  TransactionType,
  SwapResponse,
  Swap,
  TokenPayment,
  NftPayment
} from "./InfinitySwap.types"
export interface InfinityPoolReadOnlyInterface {
  ...
  poolsById: ({ poolIds }: { poolIds: number[] }) => Promise<PoolsByIdResponse>
  poolsByOwner: ({
    owner,
    queryOptions
  }: {
...
export class InfinityPoolQueryClient implements InfinityPoolReadOnlyInterface {
  ...
  constructor(client: CosmWasmClient, contractAddress: string) {
    ...
    this.simDirectSwapTokensForSpecificNfts =
      this.simDirectSwapTokensForSpecificNfts.bind(this)
    this.simSwapTokensForSpecificNfts =
      this.simSwapTokensForSpecificNfts.bind(this)
...
export class InfinityPoolClient
  extends InfinityPoolQueryClient
  implements InfinityPoolInterface
{
  ...
  constructor(
    ...
    this.directSwapTokensForSpecificNfts =
      this.directSwapTokensForSpecificNfts.bind(this)
